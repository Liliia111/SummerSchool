    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.CharField(choices=[(categories.models.SocialNetworkChoice('Facebook'), 'Facebook'),
                                                     (categories.models.SocialNetworkChoice('Twitter'), 'Twitter'),
                                                     (categories.models.SocialNetworkChoice('Google'), 'Google')], max_length=8)),
